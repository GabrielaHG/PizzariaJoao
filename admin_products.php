...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         <a href="admin_product_update.php?update=<?= $fetch_products['id']; ?>" class="option-btn">Atualizar</a>
         <a href="admin_products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('Deletar este produto?');">Deletar</a>
      </div>
   </div>
   <?php
         }
