...
if(isset($_POST['register'])){
   ...
   if($select_user->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $message[] = 'Cadastrado, entre por favor!';
      }
   }
...
if(isset($_POST['add_to_cart'])){
   ...
   if($user_id == ''){
      $message[] = 'Entre primeiro, por favor!';
   }else{
...
if(isset($_POST['order'])){
   ...
   if($user_id == ''){
      ...
      $address = 'ape n°.'.$_POST['flat'].', '.$_POST['street'].' - '.$_POST['pin_code'];
...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo"><span>P</span>izza do João</a>
   ...
   <section>
      ...
      <div class="flex">
         ...
         <form action="user_login.php" method="post">
            <h3>Entrar</h3>
            <input type="email" name="email" required class="box" placeholder="Insira seu email" maxlength="50">
            <input type="password" name="pass" required class="box" placeholder="Insira sua senha" maxlength="20">
            <input type="submit" value="Entrar" name="login" class="btn">
         </form>

         <form action="" method="post">
            <h3>Cadastre-se</h3>
            <input type="text" name="name" oninput="this.value = this.value.replace(/\s/g, '')" required class="box" placeholder="Insira seu nome de usuário" maxlength="20">
            <input type="email" name="email" required class="box" placeholder="Insira seu email" maxlength="50">
            <input type="password" name="pass" required class="box" placeholder="Insira sua senha" maxlength="20" oninput="this.value = this.value.replace(/\s/g, '')">
            ...
            <input type="submit" value="Cadastrar" name="register" class="btn">
         </form>
...
<div class="my-orders">
   ...
   <section>
      ...
      <div class="box">
         ...
         <p> Status: <span style="color:<?php if($fetch_orders['payment_status'] == 'Em produção'){ echo 'red'; }else{ echo 'green'; }; ?>"><?= $fetch_orders['payment_status']; ?></span> </p>
      </div>
      <?php
         }
      }else{
         echo '<p class="empty">Sem pedidos realizados!</p>';
      }
      ?>
...
<div class="shopping-cart">
   ...
   <section>
      ...
      ?>
      <div class="box">
         <a href="index.php?delete_cart_item=<?= $fetch_cart['id']; ?>" class="fas fa-times" onclick="return confirm('Deletar este item?');"></a>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <form action="" method="post">
            ...
            <input type="submit" class="btn" name="add_to_cart" value="Adicionar">
         </form>
      </div>
      <?php
         }
...
<section class="order" id="order">
   ...
   <?php
      ...
      <div class="flex">
         <div class="inputBox">
            <span>Nome:</span>
            <input type="text" name="name" class="box" required placeholder="Insira seu nome..." maxlength="20">
         </div>
         <div class="inputBox">
            <span>Número:</span>
            <input type="number" name="number" class="box" required placeholder="Insira seu número..." min="0" max="9999999999" onkeypress="if(this.value.length == 10) return false;">
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            ...
            <input type="text" name="flat" class="box" required placeholder="N° do ape..." maxlength="50">
         </div>
         <div class="inputBox">
            <span>Endereço:</span>
         ...
         <div class="inputBox">
            <span>CEP:</span>
            <input type="number" name="pin_code" class="box" required placeholder="CEP..." min="0" max="999999999" onkeypress="if(this.value.length == 6) return false;">
         </div>
      </div>

      <input type="submit" value="Pedir" class="btn" name="order">
...
<section class="faq" id="faq">
   ...
   <div class="accordion-container">
      ...
      <div class="accordion">
         <div class="accordion-heading">
            <span>Como é feita as pizzas?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis, quas. Quidem minima veniam accusantium maxime, doloremque iusto deleniti veritatis quos.
