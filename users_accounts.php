...
<section class="accounts">
   ...
   <h1 class="heading">Contas usuários</h1>
   ...
   <div class="box">
      ...
      <a href="users_accounts.php?delete=<?= $fetch_accounts['id']; ?>" onclick="return confirm('Deletar esta conta?')" class="delete-btn">Deletar</a>
   </div>
   <?php
         }
      }else{
