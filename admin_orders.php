   ...
   <div class="box">
      ...
      <form action="" method="post">
        ...
        <div class="flex-btn">
         ...
         <a href="admin_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('Deletar este pedido?');">Deletar</a>
        </div>
      </form>
   </div>
   <?php
         ...
         echo '<p class="empty">Sem pedidos feitos!</p>';
      }
   ?>
